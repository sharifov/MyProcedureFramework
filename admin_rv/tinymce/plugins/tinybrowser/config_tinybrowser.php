...
//include('../../../tiny_conf.php');
// File upload paths (set to absolute by default)
$tinybrowser['path']['image'] = '/files/image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/files/media/'; // Media files location
$tinybrowser['path']['file'] ='/files/file/'; // Other files location
